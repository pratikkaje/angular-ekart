...
export class ProductListComponent {
  products = [
    ...
    },
    {
      ...
      is_in_inventory: false,
      items_left: 3,
      imageURL: "https://www.hushpuppies.com.pk/cdn/shop/products/009590083-011_1_adcf84d2-0b3d-4834-af06-a6f7ff00eba0.jpg?v=1615618276",
      slug: "ss-pm-0093"
    },
    {
      id: 26,
    ...
    },
    {
      ...
      is_in_inventory: true,
      items_left: 3,
      imageURL: "https://www.reebok.ae/media/catalog/product/cache/aa703a0b704cee042f69ab8fe70bf568/h/0/h04168_1_9.jpg",
  ...
  totalItemsInStock : number = this.products.filter( p => p.is_in_inventory === true).length;
  totalItemsOutOfStock : number = this.products.filter(p => p.is_in_inventory == false).length;
}
